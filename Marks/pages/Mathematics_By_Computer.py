...
marks_df = pd.DataFrame(
    [
        {"Type": "Moodle Quizzes","Weighting":0.1, "Percentage": 1, "Actual Mark?": "Yes", "Colour":"#0000ff"},
        {"Type": "Assignment 1","Weighting":0.1333333333, "Percentage": 1, "Actual Mark?": "Yes", "Colour":"#0000ff"},
        {"Type": "Assignment 2","Weighting":0.1333333333, "Percentage": 0.95, "Actual Mark?": "Yes", "Colour":"#0000ff"},
        {"Type": "Assignment 3","Weighting":0.1333333333, "Percentage": 1, "Actual Mark?": "Yes", "Colour":"#0000ff"},
        {"Type": "Machine Learning Project","Weighting":0.50, "Percentage": 0.85, "Actual Mark?": "No", "Colour":"#0000ff"},
    ]
)
...
st.title("Mathematics by Computer Marks")

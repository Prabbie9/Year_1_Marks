...
marks_df = pd.DataFrame(
    [
        {"Type": "Assignment 1","Weighting":0.15, "Percentage": 0.9917, "Actual Mark?": "Yes", "Colour":"#0000ff"},
        {"Type": "Assignment 2","Weighting":0.15, "Percentage": 0.90, "Actual Mark?": "No", "Colour":"#0000ff"},
        {"Type": "Final Exam","Weighting":0.70, "Percentage": 0.85, "Actual Mark?": "No", "Colour":"#0000ff"},
    ]
)
...
st.title("Statistical Laboratory Marks")
